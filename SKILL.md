...
description: >
  ...
  Use when: (1) the user says things like "think deeply", "think hard", 
  "ultrathink", "use junto", "consult the panel", "I need to think about this", 
  "high-stakes decision", "important decision", "think hard about", 
  "think carefully", (2) the user faces a consequential
...
Invoke the `think` MCP tool when the stakes justify ~60-120 seconds of wait time and ~$0.10-$0.50 of cost. Good signals:
...
- **`pro`** (optional, default false): Uses GPT-5.2 Pro instead of GPT-5.2. 5-10x slower and more expensive. Only for exceptional situations where maximum depth is warranted or explicitly requested.
